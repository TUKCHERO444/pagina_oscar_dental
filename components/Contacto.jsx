...
export default function Contacto() {
  return (
    <section id="contacto" className="py-24 bg-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <FadeIn variant="up" delay={150}>
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-light-border hover:shadow-md transition-shadow h-full">
              <h3 className="font-heading text-xl font-semibold text-dark mb-6">Encuéntranos</h3>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <form className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input type="tel" id="telefono" className="w-full px-3 py-2 rounded-lg border border-light-border text-dark text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all duration-200" />
                  </div>
                </div>
                <div>
                  <label htmlFor="email" className="block text-sm font-medium text-dark mb-1">Correo</label>
                  <input type="email" id="email" className="w-full px-3 py-2 rounded-lg border border-light-border text-dark text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all duration-200" />
                </div>
                <div>
                ...
                <div>
                  ...
                  <textarea id="mensaje" rows={4} className="w-full px-3 py-2 rounded-lg border border-light-border text-dark text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary resize-none transition-all duration-200" />
                </div>
                <button type="submit" className="w-full bg-primary hover:bg-primary-dark text-white py-3 rounded-lg font-semibold transition-all duration-200 hover:shadow-lg">
                  Enviar
                </button>
              </form>
            </div>
        ...
        <FadeIn variant="up" delay={200}>
          <div className="mt-12 rounded-2xl overflow-hidden border border-light-border">
            <iframe
